...
public class singleMachineEAG_inipop extends singleMachineEAG {
  public singleMachineEAG_inipop() {
  }
  ...
  double beta;
  cloneI clone1;
 boolean executeAdaptive = false;    //true: EAG-AD
  ...
  public void initiateVars(){
    GaMain     = new guidedMutationMain_inipop();
  ...
  public void start(){
    ...
    writeFile("EAG_0218_125000", implementationResult);
