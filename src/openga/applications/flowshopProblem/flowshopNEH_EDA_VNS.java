...
public class flowshopNEH_EDA_VNS extends flowshopNEH_EDA {
    public flowshopNEH_EDA_VNS() {
    }
    ...
    public void initiateVars(){
        GaMain     = new singleThreadGAwithinipop_EDA_VNS();//singleThreadGA singleThreadGAwithSecondFront singleThreadGAwithMultipleCrossover adaptiveGA
    ...
    public void start(){
        ...
        writeFile("Flowshop_EDA_0825_review", implementResult);
    ...
    public static void main(String[] args) {
        ...
        int popSize[] = new int[]{1000};//50, 100, 155, 210
        int counter = 0;
        ...
        int numberOfCrossoverTournament[] = new int[]{2};//{1, 2, 4} //1
                                        ...
                                        for(int u = 0 ; u < crossoverRate.length ; u ++ ){
                                            for(int t = 0 ; t < mutationRate.length ; t ++ ){
                                                ...
                                                for(int i = 0 ; i < repeatExperiments ; i ++ ){
                                                    ...
                                                    flowshopNEH_EDA_VNS flowshop1 = new flowshopNEH_EDA_VNS();   //ct
