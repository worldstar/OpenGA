...
public class twoPointCrossover2withAdpative implements CrossoverI{
  public twoPointCrossover2withAdpative() {
  }
  ...
  public void startCrossover(){
    ...
    //System.out.println("in crossover maxFitness and avg "+maxFitness+" "+avgFitness);
