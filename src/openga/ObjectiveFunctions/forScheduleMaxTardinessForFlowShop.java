...
public class forScheduleMaxTardinessForFlowShop extends forScheduleMaxTardiness {
  public forScheduleMaxTardinessForFlowShop() {
  }
  ...
  public void calcObjectives() {
   ...
   //assign each job to each machine depended on the current machine time.
    for(int i = 0 ; i < length ; i ++ ){
      ...
      if(machineTime[numberOfMachine - 1]  > dueDay[index]){
        tempTardiness = (machineTime[numberOfMachine - 1] - dueDay[index]);
      }
      else{
        tempTardiness = 0;
      }
  ...
  public static void main(String[] args) {
    forScheduleMaxTardinessForFlowShop forScheduleMaxTardinessForFlowShop1 = new forScheduleMaxTardinessForFlowShop();
    ...
    int processingTime[][];//[job][machine]
    ...
    forScheduleMaxTardinessForFlowShop1.setScheduleData(DueDay, processingTime,numberOfMachine );
    forScheduleMaxTardinessForFlowShop1.setData(chromosome1);
    forScheduleMaxTardinessForFlowShop1.calcObjectives();

    //printClass1.printMatrix("machine time",forScheduleMaxTardinessForFlowShop1.machineTime);
    System.out.println(forScheduleMaxTardinessForFlowShop1.getObjectiveValue());
