...
public class flowshopNEH_EAGSGA extends flowshopProbMatrix{
    public flowshopNEH_EAGSGA() {
    }
    ...
    public void initiateVars(){
        GaMain     = new guidedMutationMainInitialPop2();
        ...
        GaMain.setSecondaryCrossoverOperator(Crossover2, true);    //for SGA
        GaMain.setSecondaryMutationOperator(Mutation2, true);     //for SGA
    }
    ...
    public void start(){
        ...
        //constructInitialSolutions2(Population); //ct
        GaMain.startGA();
        timeClock1.end();
        ...
        writeFile("NEH_1EAG5SGA_div02_5parents_7", implementationResult);
                            ...
                            for(int m = 0 ; m < lamda.length ; m ++ ){
                                for(int n = 0 ; n < beta.length ; n ++ ){
                                    if((jobs[j] <= 100) || (jobs[j] == 200 && machines[s] >= 10) || (jobs[j] == 500 && machines[s] == 20)){
                                        flowshopNEH_EAGSGA flowshop1 = new flowshopNEH_EAGSGA();
