 ...
 * @version 1.0
 */
public class singleMachineSetupSAPT_eACGA_rls extends singleMachineSetup {   //ct

    public singleMachineSetupSAPT_eACGA_rls() {
    }
    ...
    public void initiateVars() {
        GaMain = new singleThreadGAwithProbabilityMatrixILRLS();  //singleThreadGAwithProbabilityMatrixILLS()---eACGA_VNS, singleThreadGAwithProbabilityMatrix2----ACGA_VNS
...
//        implementationResult += fileName + "\t" + evaporationMethod + "\t" + obj0 + "\t" + timeClock1.getExecutionTime() / 1000.0 + "\n";
        ...
        writeFile("SingleMachineSetup_eACGA_RLS_50_i1r20_d01p", implementationResult);
...
//        System.exit(0);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("SingleMachineSetupSAPT_eACGA_rls");
        ...
        double betalearningrate[] = new double[]{0.5};   //0.5
                                    ...
                                    for (int lx = 0; lx < lamdalearningrate.length; lx++) {
                                        for (int bx = 0; bx < betalearningrate.length; bx++) {
                                            ...
                                            for (int i = 0; i < repeatExperiments; i++) {
                                                singleMachineSetupSAPT_eACGA_rls singleMachine1 = new singleMachineSetupSAPT_eACGA_rls();
