...
import java.util.logging.Level;// 有更改***************************************************
import java.util.logging.Logger;// 有更改***************************************************
...
public class singleMachineOAS_SGA_Co2 extends mTSPSGATwoPart {
  ...
  ObjFunctionCo2I[] ObjectiveFunction;
  String instanceName = "";
  ...
  public void setParameter(double crossoverRate, double mutationRate, int counter, double elitism,
          ...
          double[] r, double[] p, double[] d, double[] d_bar, double[] e, double[] w, double[][] s) { // 有更改***************************************************
    ...
    this.starttime = starttime;// 有更改***************************************************
    this.Process = p;// 有更改***************************************************
    this.Power = Power;// 有更改***************************************************
  }
  ...
  public void initiateVars() {
    ...
    ObjectiveFunction = new ObjFunctionCo2I[numberOfObjs];// 有更改***************************************************
    ObjectiveFunction[0] = new ObjFunctionCo2();// 有更改***************************************************************
...
//    Population.
    ...
    ObjectiveFunction[0].setData(this.Process);// 有更改***************************************************
...
counter++;
      ...
      Logger.getLogger(singleMachineOAS_SGA_Co2.class.getName()).log(Level.SEVERE, null, ex); 
    }
  }
