...
public class singleMachineDPwithProbMatrix extends singleMachineWithHeu1 {
  public singleMachineDPwithProbMatrix() {
  }
      ...
      for(int m = 0 ; m < jobSets.length ; m ++ ){//jobSets.length
        for(int k = 8 ; k < 9 ; k ++ ){
          //if((jobSets[m] <= 50 && (k != 0 && k != 3 && k != 6 && k != 21 && k != 24 && k != 27 && k != 42 && k != 45 && k != 48)) ||  (jobSets[m] > 50 && k < 9)){
            singleMachineDPwithProbMatrix singleMachine1 = new singleMachineDPwithProbMatrix();
