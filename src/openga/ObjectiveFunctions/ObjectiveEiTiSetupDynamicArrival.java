...
/**
 * <p>Title: Single machine scheduling problem with setup and dynamic arrival time in a common due day environment.</p>
 * <p>Description: Calculate the earliness and tardiness cost.</p>
...
public class ObjectiveEiTiSetupDynamicArrival implements ObjectiveFunctionMatrixPTimeScheduleI, alphaBetaI{
  public ObjectiveEiTiSetupDynamicArrival() {
  }
