 ...
 */
public class singleThreadGAwithProbabilityMatrixjEDA extends singleThreadGA implements probabilityMatrixI {

    public singleThreadGAwithProbabilityMatrixjEDA() {
    }
    //PBILInteractive PBIL1;   //PBIL
    PBILInteractivejEDA PBIL2;  //jEDA
    double container[][];
    double inter[][];
    openga.operator.miningGene.probabilityMatrixInteractiveLjEDA probMatrix1 = new openga.operator.miningGene.probabilityMatrixInteractiveLjEDA();
...
/*
            if (i == 500) {
                ...
                generationResults = i + "\t" + getBest() + "\n";
                //System.out.print(generationResults);
                writeFile("jEDA1005_6_" + i, generationResults);
            }
            if (i == 750) {
                String generationResults = "";
                generationResults = i + "\t" + getBest() + "\n";
...
//
    ...
    public void ProbabilityMatrix() {
        ...
        probMatrix1.setDuplicateRate(0.1);
