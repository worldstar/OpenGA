 ...
 */
public class mTSPSGAOneChromosome extends TSP {
...
double distanceMatrix[][];
 ...
 public void setParameter(int instance, double crossoverRate, double mutationRate, int counter,
  ...
  public void initiateVars(){   
    ...
    ObjectiveFunction[0] = new ObjectiveFunctionMTSPOneChromosome();//the first objective
            ...
            for(int n = 0 ; n < elitism.length ; n ++ ){
              for(int p = 0 ; p < numberOfSalesmen.length ; p ++){
                for(int m = 0 ; m < repeat ; m ++ ){
                  ...
                  mTSPSGAOneChromosome TSP1 = new mTSPSGAOneChromosome();
