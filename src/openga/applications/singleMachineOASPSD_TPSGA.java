 ...
 */
public class singleMachineOASPSD_TPSGA extends singleMachineOAS_TPSGA {
...
//    Population.
  ...
  public static void main(String[] args) {
    ...
    double[] alpha = new double[]{0};//0.2, 0.1, 0.05 [0.2]
                          ...
                          for (int pop_Size = 0; pop_Size < populationsSize.length; pop_Size++) {
                            for(int s = 0 ; s < b.length ; s++){
                              for (int r = 0; r < repeat; r++) {
                                ...
                                singleMachineOASPSD_TPSGA TSP1 = new singleMachineOASPSD_TPSGA();
                                TSP1.alpha = alpha[q];
                                TSP1.setParameter(crossoverRate[m], mutationRate[n], counter, elitism[o], generations[0],
                                        crossoverType[t], numberOfSalesmen[p], OASInstances1.getSize(), FileName,
