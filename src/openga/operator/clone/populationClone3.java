...
public class populationClone3 {
  public populationClone3() {
  }
  ...
  public void startClonePopulation(int i){
  ...
  public populationI generateNewPopulation(populationI population1, double _weight[]){
    ...
    for(int i = 0 ; i < archiveSize ; i ++ ){
     ...
     counter = 0;
     for(int i = archiveSize ; i < 2*archiveSize ; i ++ ){
   ...
   for(int i = 2*archiveSize ; i < numberOfClone ; i ++ ){
     getPopulationIndex();
     ...
     //population1.setSingleChromosome(i, generateNewSolution(cloneChromosome));
