...
import openga.operator.miningGene.PBILInteractiveWithEDA3V3I;
 ...
 * @version 1.0
 */
public class singleMachineEDA3V3 extends singleMachineEDA2 implements Runnable {

    public singleMachineEDA3V3() {
    }
    
    public PBILInteractiveWithEDA3V3I GaMain;
//    public EDAMainI GaMain;
    ...
    //Single thread
    public void setEDAinfo(double lamda, double beta, int numberOfCrossoverTournament, int numberOfMutationTournament, int startingGenDividen , boolean OptMin , double DEFAULT_crossoverRate , double DEFAULT_mutationRate , int epoch ) {
        this.lamda = lamda;
        this.beta = beta;
    ...
    public void initiateVars() {
        GaMain = new singleThreadGAwithEDA3V3();//singleThreadGA singleThreadGAwithSecondFront singleThreadGAwithMultipleCrossover adaptiveGA
        ...
        GaMain.setEDAinfo(lamda, beta, numberOfCrossoverTournament, 
                ...
                , OptMin , epoch);  //startingGenDividen here is as interval of EDA
    ...
    public void startMain() {
        ...
        implementResult = fileName + "\t" + lamda + "\t" + beta + "\t" + numberOfCrossoverTournament 
                + "\t" + numberOfMutationTournament + "\t" + startingGenDividen + "\t" + OptMin + "\t" + epoch + "\t"
...
//            System.out.println(instanceReplications);
  ...
  //                    if ((jobSets[j] <= 50 && (k == 0 || k == 3 || k == 6 || k == 21 || k == 24 || k == 27 || k == 42 || k == 45 || k == 48)) || (jobSets[j] > 50 && k < 9)) {
          ...
          //                                            System.out.println("Combinations: " + counter);
                                                      ...
                                                      singleMachineEDA3V3 singleMachine1 = new singleMachineEDA3V3();
                                                      ...
                                                      singleMachine1.setEDAinfo(lamdalearningrate[lx], betalearningrate[bx], numberOfCrossoverTournament[m], 
                                                              numberOfMutationTournament[n], startingGenDividen[p] , optMin , 
