 ...
 */
public class singleMachineOAS_TPSGAWithTOU extends mTSPSGATwoPart {
  ...
  public singleMachineOAS_TPSGAWithTOU() {
  }
                        ...
                        for (int q = 0; q < alpha.length; q++) {
                          for (int pop_Size = 0; pop_Size < populationsSize.length; pop_Size++) {
                            for (int r = 0; r < repeat; r++) {
                              ...
                              singleMachineOAS_TPSGAWithTOU TSP1 = new singleMachineOAS_TPSGAWithTOU();
                              TSP1.alpha = alpha[q];
