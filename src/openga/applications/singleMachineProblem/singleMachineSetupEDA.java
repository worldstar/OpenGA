...
public class singleMachineSetupEDA extends singleMachineSetup{
  public singleMachineSetupEDA() {
  }
  double lamda = 0.9; //CT
...
public void setEDAinfo(double lamda, int numberOfCrossoverTournament, int numberOfMutationTournament, int startingGenDividen){
 ...
 public int getBestSolnIndex(populationI arch1){
  ...
  public void startMain(){
    ...
    implementationResult += fileName+"\t"+numberOfJob+"\t"+lamda+"\t"+numberOfCrossoverTournament+"\t" +numberOfMutationTournament+"\t" +GaMain.getArchieve().getSingleChromosome(bestInd).getObjValue()[0]+"\t"+timeClock1.getExecutionTime()/1000.0+"\n";
    writeFile("SingleMachineSetupEDA_20081128_"+startingGenDividen, implementationResult);
...
*/
  ...
  public static void main(String[] args) {
    System.out.println("SingleMachineSetupEDA_20081128");
                      ...
                      for (int n = 0; n < numberOfMutationTournament.length; n++) {
                         for(int p = 0 ; p < startingGenDividen.length ; p++){                             
                                for(int i = 0 ; i < repeatExperiments ; i ++ ){
                                 ...
                                 singleMachineSetupEDA singleMachine1 = new singleMachineSetupEDA(); //CT
