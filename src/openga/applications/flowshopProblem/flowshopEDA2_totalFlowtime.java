 ...
 * @version 1.0
 */
public class flowshopEDA2_totalFlowtime extends flowshopNEH_EDA2_VNS {

    public flowshopEDA2_totalFlowtime() {
    }
                                    ...
                                    for (int n = 0; n < numberOfMutationTournament.length; n++) {
                                        for (int p = 0; p < startingGenDividen.length; p++) {
                                            for (int i = 0; i < repeatExperiments; i++) {
                                                ...
                                                flowshopEDA2_totalFlowtime flowshop1 = new flowshopEDA2_totalFlowtime();
