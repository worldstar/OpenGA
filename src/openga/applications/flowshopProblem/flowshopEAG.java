...
public class flowshopEAG extends flowshopProbMatrix{
  public flowshopEAG() {
  }
  ...
  public void start(){
    ...
    writeFile("EAG_DOE_Flowshop20080310", implementationResult);
  ...
  public static void main(String[] args) {
    ...
    int counter = 0;
    double crossoverRate[] = new double[]{1.0},//0.6, 0.9 {0.6}
