...
public class singleMachineSetupDP_ACGA extends singleMachineSetupDP {   //ct
  public singleMachineSetupDP_ACGA() {
  }
  ...
  public void start(){
    ...
    writeFile("SingleMachineSetupDP_ACGA_Evaporation20081122", implementationResult);
              ...
              for(int p = 0 ; p < strategy.length ; p ++ ){
                for(int q = 0 ; q < evaporationMethod.length ; q ++ ){
                  ...
                  for(int i = 0 ; i < repeatExperiments ; i ++ ){
                    singleMachineSetupDP_ACGA singleMachine1 = new singleMachineSetupDP_ACGA();
