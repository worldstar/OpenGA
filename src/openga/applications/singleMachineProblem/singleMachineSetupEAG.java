...
public class singleMachineSetupEAG extends  singleMachineEAG {   //ct
    public singleMachineSetupEAG() {
    }
    ...
    public void start(){
        ...
        writeFile("SingleMachineSetup_EAG_20081223", implementationResult);
   ...
   */
    ...
    public static void main(String[] args) {
        System.out.println("SingleMachinesetup_EAG_20081223");
        ...
        //Parameters of Guided Mutation.
        double[] lamda = new double[]{0.1, 0.5, 0.9}; //learning rate{0.1, 0.5, 0.9} {0.9 is better}
        double[] beta = new double[]{0.1, 0.5, 0.9};//Percentage of local information{0.1, 0.5, 0.9} {0.5 is significant}
                        ...
                        for(int j = 0 ; j < lamda.length ; j ++ ){
                            for(int n = 0 ; n < beta.length ; n ++ ){
                                for(int i = 0 ; i < repeatExperiments ; i ++ ){
                                    singleMachineSetupEAG singleMachine1 = new singleMachineSetupEAG();
