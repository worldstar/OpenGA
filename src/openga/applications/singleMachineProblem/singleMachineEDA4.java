...
import openga.operator.miningGene.PBILInteractiveWithEDA4I;
 ...
 * @version 1.0
 */
public class singleMachineEDA4 extends singleMachineEDA2 implements Runnable {

    public singleMachineEDA4() {
    }
    
    public PBILInteractiveWithEDA4I GaMain;
...
//    }
    ...
    //Single thread
    public void setEDAinfo(double lamda, double beta, int numberOfCrossoverTournament, int numberOfMutationTournament, int startingGenDividen , int D1 , int D2 , boolean OptMin , double DEFAULT_crossoverRate , double DEFAULT_mutationRate , int epoch , int stopGeneration) {
        this.lamda = lamda;
        this.beta = beta;
        this.numberOfCrossoverTournament = numberOfCrossoverTournament;
        this.numberOfMutationTournament = numberOfMutationTournament;
    ...
    public void initiateVars() {
        GaMain = new singleThreadGAwithEDA4();//singleThreadGA singleThreadGAwithSecondFront singleThreadGAwithMultipleCrossover adaptiveGA
        ...
        GaMain.setEDAinfo(lamda, beta, numberOfCrossoverTournament, 
                ...
                , D1 , D2 , OptMin , epoch , stopGeneration);  //startingGenDividen here is as interval of EDA
    ...
    public void startMain() {
        ...
        implementResult = fileName + "\t" + lamda + "\t" + beta + "\t" + numberOfCrossoverTournament 
                + "\t" + numberOfMutationTournament + "\t" + startingGenDividen + "\t" 
                + D1 + "\t" + D2 + "\t" + OptMin + "\t" + epoch + "\t" + stopGeneration +"\t"
        ...
        writeFile("singleMachineEDA4", implementResult);
...
//        int jobSets[] = new int[]{20,50,90};//20, 30, 40, 50, 60, 90, 100, 200//20, 40, 60, 80 //20,30,40,50,60,90//20,50,90
        ...
        int jobSets[] = new int[]{60,90};//20, 30, 40, 50, 60, 90, 100, 200//20, 40, 60, 80 //20,30,40,50,60,90//20,50,90
...
//        int jobSets[] = new int[]{100,200};//bky
        ...
        double crossoverRate[] = new double[]{0.1,0.5},//0.6, 0.9 {0.9}//0.1,0.5,0.9
                mutationRate[] = new double[]{0.5,0.9},//0.1, 0.5 {0.5}//0.1,0.5,0.9
                elitism = 0.1;

        //EDA parameters.
        double lamdalearningrate[] = new double[]{0.1,0.5,0.9};//0.1, 0.5, 0.9
        double betalearningrate[] = new double[]{0.1,0.5,0.9};  //0.1, 0.5, 0.9
        int numberOfCrossoverTournament[] = new int[]{1,2,4};//{1,2,4,5} 
        int numberOfMutationTournament[] = new int[]{1,2};//{1,2,4}
        int startingGenDividen[] = new int[]{2,4,7};//{2,4,7}
        
        int[] D1 = new int[]{0,1,2};//0,1,2
        int[] D2 = new int[]{0,1,2};//0,1,2
        boolean optMin = true;
        int[] epoch = new int[]{5,6,7};//2,4,6
        int[] intervalGeneration = new int[]{2,4,7};//2,4,7
                                                  ...
                                                  for(int D1Count = 0 ; D1Count < D1.length ; D1Count++) {
                                                      for(int D2Count = 0 ; D2Count < D2.length ; D2Count++) {
                                                        for(int epochCount = 0; epochCount < epoch.length ; epochCount++){
                                                          for(int IGCount = 0 ; IGCount < intervalGeneration.length ; IGCount ++){
                                                            for (int i = 0; i < repeatExperiments; i++) {
                  //                                            System.out.println("Combinations: " + counter);

                                                              singleMachineEDA4 singleMachine1 = new singleMachineEDA4();
                                                              ...
                                                              singleMachine1.setEDAinfo(lamdalearningrate[lx], betalearningrate[bx], numberOfCrossoverTournament[m], 
                                                                      ...
                                                                      crossoverRate[CRCount] , mutationRate[MRCount], epoch[epochCount] , intervalGeneration[IGCount]);
