...
public class flowshopGLS_EDA extends flowshopGLS {
  public flowshopGLS_EDA() {
  }
  ...
  public void initiateVars(){
    ...
    localSearch1 = new localSearchByShiftMutationEDA();//localSearchBy2OptEDA localSearchByShiftMutationEDA
  ...
  public void start(){
    ...
    implementResult = fileName+"\t" + maxNeighborhood+"\t"+lamda+"\t"
       +GaMain.getArchieve().getSingleChromosome(bestInd).getObjValue()[0]+"\t"
        +timeClock1.getExecutionTime()/1000.0+"\n";
    writeFile("GLSEDA_Flowshop_shitMutationEDA_20080923", implementResult);
  ...
  public static void main(String[] args) {
    System.out.println("GLSEDA_Flowshop20080923");
           ...
           for (int k = 0; k < maxNeighborhood.length; k++) {
             for (int m = 0; m < lamda.length; m++) {
               for (int i = 0; i < repeatExperiments; i++) {
                 ...
                 flowshopGLS_EDA flowshop1 = new flowshopGLS_EDA();
                 ...
                 flowshop1.setEDAinfo(lamda[m], startingGenDividen[0]);
