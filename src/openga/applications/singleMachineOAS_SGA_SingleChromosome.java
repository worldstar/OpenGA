...
public class singleMachineOAS_SGA_SingleChromosome extends mTSPSGATwoPart {
...
//  singleThreadGA GaMain;
  ...
  public singleMachineOAS_SGA_SingleChromosome() {
  }
  ...
  public void initiateVars() {
    GaMain = new singleThreadGA_SingleChromosome();
    Population = new population();
    Selection = new binaryTournament();
    Crossover = new PMX();
    Mutation = new swapMutation();
    ObjectiveFunction = new ObjectiveFunctionOASI[numberOfObjs];
    ObjectiveFunction[0] = new ObjectiveFunctionforOAS_SingleChromosome();
  ...
  public static void main(String[] args) {
    ...
    int[] orders = new int[]{10,15,20};//10, 15, 20, 25, 50, 100
...
//                              generations[0] = orders[i] * (numberOfSalesmen[p] - 1) * 2000 / populationsSize[pop_Size];
                            generations[0] = 5000;
                            singleMachineOAS_SGA_SingleChromosome TSP1 = new singleMachineOAS_SGA_SingleChromosome();
                            TSP1.alpha = alpha[q];
