...
public class localSearchBySwapEDA extends localSearchBySwap {
  public localSearchBySwapEDA() {
  }
  ...
  //To estimated the fitness of jobs at the cutPoint1 and cutPoint2.
  public double fitnessSurrogate(chromosome chromosomes1, int cutPoint1, int cutPoint2){
    double estimatedFitness = 0;

    int jobIndex = chromosomes1.getSolution()[cutPoint1];
    estimatedFitness += container[jobIndex][cutPoint1];
    jobIndex = chromosomes1.getSolution()[cutPoint2];
    estimatedFitness += container[jobIndex][cutPoint2];
