...
public class singleMachineDPEAG extends singleMachinewithProbMatrix {
  public singleMachineDPEAG() {
  }
  ...
  public void start(){
    ...
    writeFile("SingleMachine_EAG_20080323", implementationResult);
...
//  -------------------  ct
  ...
  public static void main(String[] args) {
    ...
    int jobSets[] = new int[]{30, 40, 50};//20, 30, 40, 50, 60, 90, 100, 200
    int counter = 0;
