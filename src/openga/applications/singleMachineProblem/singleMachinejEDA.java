 ...
 * @version 1.0
 */
public class singleMachinejEDA extends singleMachineWithHeu1 {

    public singleMachinejEDA() {
    }
    ...
    public void initiateVars() {
        GaMain = new singleThreadGAwithProbabilityMatrixjEDA();
    ...
    public void start() {
        ...
        writeFile("SingleMachine_jEDA_1005_6", implementationResult);
                            ...
                            for (int p = 0; p < strategy.length; p++) {
                                for (int q = 0; q < evaporationMethod.length; q++) {
                                    for (int i = 0; i < repeatExperiments; i++) {
                                        singleMachinejEDA singleMachine1 = new singleMachinejEDA();
