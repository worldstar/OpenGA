 ...
 */
public class singleMachineOAS_TPSGA_Co2 extends mTSPSGATwoPart {
  ...
  public singleMachineOAS_TPSGA_Co2() {
  }
...
//    Population.
    ...
    ObjectiveFunction[0].setPowerData(p, power);//***update***
                        ...
                        for (int q = 0; q < alpha.length; q++) {
                          for (int pop_Size = 0; pop_Size < populationsSize.length; pop_Size++) {
                            for (int r = 0; r < repeat; r++) {
                              ...
                              singleMachineOAS_TPSGA_Co2 TSP1 = new singleMachineOAS_TPSGA_Co2();
                              TSP1.alpha = alpha[q];
