 ...
 * @version 1.0
 */
public class singleThreadGAwithinipop_EDA_VNS extends singleThreadGAwithinipop_EDA implements EDAMainI {

    public singleThreadGAwithinipop_EDA_VNS() {
    }
    PBIL PBIL1;
    double container[][];
...
/*
            if (generations == 40) {
                localSearchStage(4);
            } else if (generations == 100 && i % 2 == 0) {
                localSearchStage(2);
            } else if (generations == 200 && i % 4 == 0) {
                localSearchStage(2);
            } else if (generations == 400 && i % 8 == 0) {
                localSearchStage(2);
            }
*/
        }
