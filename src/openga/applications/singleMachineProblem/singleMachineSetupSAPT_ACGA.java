 ...
 * @version 1.0
 */
public class singleMachineSetupSAPT_ACGA extends singleMachineSetup {   //ct

    public singleMachineSetupSAPT_ACGA() {
    }
    ...
    public void initiateVars() {
        GaMain = new singleThreadGAwithProbabilityMatrix2();  //singleThreadGAwithProbabilityMatrixILLS()---eACGA_VNS, singleThreadGAwithProbabilityMatrix2----ACGA_VNS
        ...
        totalSolnsToExamine = 100000;  //100000
...
//        System.exit(0);
    ...
    public void start() {
        ...
        timeClock1.start();
        constructInitialSolutionsSAPT(Population);  //ct
        totalSolnsToExamine = 100000;
//        totalSolnsToExamine = 100000 - lstimes;  //100000
        DEFAULT_generations = totalSolnsToExamine / (DEFAULT_PopSize);//ct
        GaMain.setData(Population, Selection, Crossover, Mutation, ObjectiveFunction, Fitness, DEFAULT_generations, DEFAULT_initPopSize, DEFAULT_PopSize,
                numberOfJob, DEFAULT_crossoverRate, DEFAULT_mutationRate, objectiveMinimization, numberOfObjs, encodeType, elitism);
        ...
        implementationResult += fileName + "\t" + evaporationMethod + "\t" + obj0 + "\t" + GaMain.getArchieve().getSingleChromosome(bestInd).getObjValue()[0] + "\t" + timeClock1.getExecutionTime() / 1000.0 + "\n";
        ...
        writeFile("SingleMachineSetupSAPT_ACGA_all_2011_temp", implementationResult);
...
//        System.exit(0);
    ...
    public static void main(String[] args) {
        ...
        int jobSets[] = new int[]{25};//10, 15, 20, 25, 50, 100, 150, 200
                                    ...
                                    for (int lx = 0; lx < lamdalearningrate.length; lx++) {
                                        for (int bx = 0; bx < betalearningrate.length; bx++) {
                                            ...
                                            for (int i = 0; i < repeatExperiments; i++) {
                                                singleMachineSetupSAPT_ACGA singleMachine1 = new singleMachineSetupSAPT_ACGA();
