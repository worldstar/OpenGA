 ...
 * <p>Description: A new version of calculating the total flowtime for flowshop scheduling problems.</p>
...
public class ObjectiveTotalFlowTimeForFlowShopV2 implements ObjectiveFunctionFlowShopScheduleI{
  public ObjectiveTotalFlowTimeForFlowShopV2() {
  }
  ...
  public void setData(chromosome chromosome1, int indexOfObjective){
    System.out.println("It doesn't implement this method in program ObjectiveTotalFlowTimeForFlowShopV2");
    System.exit(0);
  }
  ...
  public void calcObjective(){
    for(int i = 0 ; i < popSize ; i ++ ){
      ...
      forScheduleTotalFlowTimeForFlowShop1.setData(originalPop.getSingleChromosome(i).getLength(), processingTime, numberOfMachine);
