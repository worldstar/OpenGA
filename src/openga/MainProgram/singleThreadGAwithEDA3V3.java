 ...
 * @author Kuo Yu-Cheng
 */
public class singleThreadGAwithEDA3V3 extends singleThreadGAwithEDA2 implements PBILInteractiveWithEDA3V3I {

    public singleThreadGAwithEDA3V3() {
    }
    ...
    PBILInteractiveWithEDA3V3 PBIL1;
...
//        System.out.println(generations);
        ...
        PBIL1 = new PBILInteractiveWithEDA3V3(Population, lamda, beta , OptMin , epoch);   // PBIL
...
//            System.out.println(i + ":" + populationTemp.getPopulationSize());
            ...
            if (i % startingGenDividen != 0) {
                ...
                tempNumberOfMutationTournament = 1;
                    ...
                    PBIL1 = new PBILInteractiveWithEDA3V3(populationTemp, lamda, beta , OptMin , epoch);   // PBIL
  ...
  public void setEDAinfo(double lamda, double beta, int numberOfCrossoverTournament, 
          int numberOfMutationTournament, int startingGenDividen , boolean OptMin , int epoch ) {
