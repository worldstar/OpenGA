...
public class flowshopNEH_EDA extends flowshopSGA {
    public flowshopNEH_EDA() {
    }
    ...
    public void start(){
        ...
        writeFile("NEH_EDA_Flowshop_0603", implementResult);
                                        ...
                                        for(int u = 0 ; u < crossoverRate.length ; u ++ ){
                                            for(int t = 0 ; t < mutationRate.length ; t ++ ){
                                                ...
                                                for(int i = 0 ; i < repeatExperiments ; i ++ ){
                                                    ...
                                                    flowshopNEH_EDA flowshop1 = new flowshopNEH_EDA();   //ct
